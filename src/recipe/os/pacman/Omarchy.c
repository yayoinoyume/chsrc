...
{
  chef_prep_this_dish (os_omarchyopr, gsr);
  ...
  chef_set_note (this,
    ...
    "本菜品仅更换 OPR 源；Arch Linux 主仓库请另行 chsrc set arch，恢复官方 OPR 源请 chsrc reset omarchyopr。"
    ...
    "This dish only switches the OPR source; use chsrc set arch for the Arch Linux main source, and chsrc reset omarchyopr to restore the official OPR source. "
...
void
os_omarchyopr_resetsrc (char *option)
{
  /* reset 模式下 chsrc_use_this_source 返回官方源，即恢复官方 stable 通道 */
  os_omarchyopr_setsrc (option);
}
